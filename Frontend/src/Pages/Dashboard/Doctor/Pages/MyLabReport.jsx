        ...
        const fetchReports =
            async () => {
                try {
                    ...
                    const response =
                        await fetch(
                            `http://127.0.0.1:3000/api/v1/lab-tests/doctor/${user._id}`
                        );
                                        ...
                                        {reports.map(
                                            (
                                                ...
                                                >
                                                    ...
                                                    <td className="px-6 py-5">
                                                        <span className="bg-green-100 text-green-600 px-4 py-2 rounded-2xl font-bold">
                                                            {
                                                                item.paymentStatus
                                                            }
                                                        </span>
